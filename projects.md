...
*Note: These three articles represent an active methodological debate — Hajnal, Lajevardi, and Nielson (2017) find that voter ID laws suppress minority turnout; Grimmer et al. (2018) challenge those findings on data-quality and specification grounds; and Hajnal, Kuk, and Lajevardi (2018) respond and defend the original result. I found this debate directly relevant to my own Limitations section, since it underscores how sensitive this kind of state-level analysis is to data quality and model specification — exactly the concern I raised about my own dataset.*
